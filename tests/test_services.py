...
from src.services import analyze_cashback_categories, filter_personal_transfers, investment_bank, simple_search
...
def test_simple_search_full_match():
    transactions = [
        ...
        },
        {
            ...
            "Тип": "Пополнение	",
            "Комментарий": "Возврат средств по дог. N 3530772 от 07.04.2023. Богатов Артемий Андреевич. "
            "Без НДС по дог. N 3530772 от 07.04.2023. Богатов Артемий Андреев",
        },
    ]
...
def test_simple_search_no_match():
    transactions = [
        ...
        },
        {
            ...
            "Категория": "Пополнения",
            "Тип": "Пополнение	",
            "Комментарий": "Возврат средств по дог. N 3530772 от 07.04.2023. "
            "Богатов Артемий Андреевич. Без НДС по дог. N 3530772 от 07.04.2023. "
            "Богатов Артемий Андреев",
        },
    ]
...
def test_filter_personal_transfers_valid_data():
    transactions = [
        {
            "Описание операции": "Иван М.",
            "Комментарий": "",
            "Тип": "Списание",
            "Категория": "Финансовые операции",
        },
        {
            "Описание операции": "Анастасия О.",
            "Комментарий": "Перевод денежных средств",
            "Тип": "Списание",
            "Категория": "Финансовые операции",
        },
        {
            "Описание операции": "Руслан К.",
            "Комментарий": "",
            "Тип": "Списание",
            "Категория": "Финансовые операции",
        },
        {
            "Описание операции": "Александр К.",
            "Комментарий": "",
            "Тип": "Пополнение",
            "Категория": "Финансовые операции",
        },
    ...
    assert sorted(result, key=lambda x: (x["Описание операции"], x["Комментарий"])) == sorted(
        expected, key=lambda x: (x["Описание операции"], x["Комментарий"])
    )
